...
const SECTIONS: SubSection[] = [
  {
    ...
    img: '/images/editorial/tenderlab-domiciliary-care-hero-v1.jpg',
    paragraphs: [
  ...
  },
  {
    id: 'shared-lives',
    title: 'Shared Lives',
    img: '/images/editorial/tenderlab-shared-lives-hero-v1.jpg',
    paragraphs: [
  ...
  },
  {
    ...
    img: '/images/editorial/tenderlab-residential-care-hero-v1.jpg',
    paragraphs: [
  ...
  },
  {
    id: 'nursing-care',
    title: 'Nursing Care',
    img: '/images/editorial/tenderlab-nursing-care-hero-v1.jpg',
    paragraphs: [
      ...
      "TenderLab works with your clinical leadership team to capture the evidence that nursing care evaluators reward. We identify your clinical governance infrastructure, your outcomes data, and your complex needs management approach, and build responses that demonstrate genuine clinical expertise rather than general statements about nursing quality that could apply to any provider.",
    ],
  },
  {
    id: 'extra-care-services',
    title: 'Extra Care Services',
    img: '/images/editorial/tenderlab-extra-care-hero-v1.jpg',
    paragraphs: [
  ...
  },
  {
    ...
    img: '/images/editorial/tenderlab-reablement-rehabilitation-hero-v1.jpg',
    paragraphs: [
      ...
      "TenderLab builds reablement responses around your operational model and outcomes data. We identify the specific evidence, including goal-setting tools, outcome measures and multidisciplinary working arrangements, and structure the response so an evaluator can connect it to the published criteria.",
    ],
  },
  {
    id: 'day-services',
    title: 'Day Services',
    img: '/images/editorial/tenderlab-day-services-hero-v1.jpg',
    paragraphs: [
      "Day services form a critical resource for adults with complex needs and their carers, and commissioning bodies procuring day service contracts are acutely aware of the difference between meaningful social engagement and time-filling activity. Day service tenders require evidence that your programme delivers genuine outcomes for individuals, including improved wellbeing, social connection, skill development and maintained independence, not simply a structured day away from home.",
  ...
  },
  {
    ...
    img: '/images/editorial/tenderlab-live-in-care-hero-v1.jpg',
    paragraphs: [
  ...
  },
  {
    ...
    img: '/images/editorial/tenderlab-short-breaks-respite-hero-v1.jpg',
    paragraphs: [
  ...
  },
  {
    ...
    img: '/images/editorial/tenderlab-housing-support-hero-v1.jpg',
    paragraphs: [
      "Housing support services are often procured within broader community services frameworks, which means providers tendering for housing support contracts are competing against a wide range of organisations, including housing associations, voluntary sector providers and specialist support agencies, each with different evidence bases and commissioning relationships. Standing out in housing support procurement requires a clear articulation of your tenancy sustainment model and your prevention-focused approach.",
