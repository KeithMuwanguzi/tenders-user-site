          ...
          <div className="he-grid he-grid--3col">
            ...
            <main className="he-content-col">
              ...
              <section className="cs-block" id="sec-06">
                ...
                <p><strong>Quality-response remedy.</strong> Where your written proposal expressly includes this remedy, we will waive our professional fee for one replacement tender-writing engagement of comparable scope if the buyer&apos;s full written feedback shows that an unsuccessful result was caused solely by quality responses drafted by TenderLab failing to reach the required quality threshold. This is not a refund or a guarantee of an award. It does not apply to eligibility or selection failures, price, financial standing, insurance, mobilisation, regulatory ratings, missing or inaccurate client evidence, client amendments, late instructions, portal or procedural issues, buyer cancellation, or any other matter outside the written quality responses. You must have met the responsibilities in the engagement letter, paid all invoices, approved the final submission and supplied the buyer&apos;s complete feedback. Eligibility and the scope of any replacement engagement will be confirmed in writing under the terms of the relevant proposal.</p>
