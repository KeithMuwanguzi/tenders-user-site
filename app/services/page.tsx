...
const displayNames: Record<string, string> = {
  ...
  'pipeline-tracking': 'Tender pipeline tracking',
...
const decisionLabels: Record<string, string> = {
  ...
  'pipeline-tracking': 'You need relevant care opportunities identified and prioritised consistently.',
...
const faqs = [
  ...
  { q: 'Can several services be combined?', a: 'Yes. A provider may use pipeline tracking to find opportunities, complete bid writing for the response and mobilisation support after award. The scope is agreed around the work actually required.' },
  ...
  return (
    <main className="ep-page">
      <EditorialHero
        ...
        image="/images/editorial/tenderlab-bid-writing-hero-v1.png"
